...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onSelect }) => {
  ...
  return (
    <div className="relative group">
        <Card className="hover:shadow-lg transition-shadow cursor-pointer h-full" onClick={() => onSelect(project.id)}>
          ...
          <p className="text-xs text-neutral-400 mt-4">Created: {formatDate(project.createdAt)}</p>
        </Card>
        <div 
